...
export default function Suppliers() {
  ...
  const columns = [
    { key: 'name', label: 'Vendor Name', render: (r: any) => <span className="font-medium text-slate-900">{r.name}</span> },
    ...
    { key: 'outstandingBalance', label: 'We Owe (₹)', render: (row: any) => (
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card className="glass border-l-4 border-l-indigo-500">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-400">Total Vendors</p>
        ...
        <Card className="glass border-l-4 border-l-orange-500">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-400">Total Outstanding (To Pay)</p>
      ...
      <div className="flex justify-between items-end">
        <h2 className="text-lg font-bold text-slate-700">Vendor Directory</h2>
      </div>
